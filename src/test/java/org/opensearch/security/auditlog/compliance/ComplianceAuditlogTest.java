...
public class ComplianceAuditlogTest extends AbstractAuditlogiUnitTest {
    ...
    public void testSourceFilter() throws Exception {
        ...
        Settings additionalSettings = Settings.builder()
                ...
                //.put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_WRITE_WATCHED_INDICES, "emp")
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_READ_WATCHED_FIELDS, "emp")
    ...
    public void testUpdate() throws Exception {
        ...
        Settings additionalSettings = Settings.builder()
                ...
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_EXTERNAL_CONFIG_ENABLED, false)
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_INTERNAL_CONFIG_ENABLED, false)
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_WRITE_WATCHED_INDICES, "finance")
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_READ_WATCHED_FIELDS, "humanresources,Designation,FirstName,LastName")
                .build();
    ...
    public void testUpdatePerf() throws Exception {
        ...
        Settings additionalSettings = Settings.builder()
                ...
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_EXTERNAL_CONFIG_ENABLED, false)
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_INTERNAL_CONFIG_ENABLED, false)
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_WRITE_WATCHED_INDICES, "humanresources")
                .put(ConfigConstants.SECURITY_COMPLIANCE_HISTORY_READ_WATCHED_FIELDS, "humanresources,*")
                .build();
