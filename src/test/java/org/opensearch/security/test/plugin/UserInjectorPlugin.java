...
public class UserInjectorPlugin extends Plugin implements NetworkPlugin {
    ...
    class UserInjectingDispatcher implements Dispatcher {
        ...
        public void dispatchRequest(RestRequest request, RestChannel channel, ThreadContext threadContext) {
            threadContext.putTransient(ConfigConstants.SECURITY_INJECTED_USER, request.header(ConfigConstants.SECURITY_INJECTED_USER));
        ...
        public void dispatchBadRequest(RestChannel channel, ThreadContext threadContext, Throwable cause) {
            threadContext.putTransient(ConfigConstants.SECURITY_INJECTED_USER, channel.request().header(ConfigConstants.SECURITY_INJECTED_USER));
