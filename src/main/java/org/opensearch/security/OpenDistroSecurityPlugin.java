...
import org.opensearch.security.ssl.rest.OpenDistroSecuritySSLReloadCertsAction;
import org.opensearch.security.ssl.rest.OpenDistroSecuritySSLCertsInfoAction;

import org.opensearch.security.ssl.transport.DefaultPrincipalExtractor;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import org.opensearch.security.ssl.transport.OpenDistroSSLConfig;
...
import org.opensearch.security.rest.KibanaInfoAction;
import org.opensearch.security.rest.OpenDistroSecurityHealthAction;
import org.opensearch.security.rest.OpenDistroSecurityInfoAction;
import org.opensearch.security.rest.TenantInfoAction;
import org.opensearch.security.securityconf.DynamicConfigFactory;
import org.opensearch.security.ssl.OpenDistroSecuritySSLPlugin;
...
public final class OpenDistroSecurityPlugin extends OpenDistroSecuritySSLPlugin implements ClusterPlugin, MapperPlugin {
    ...
    public Settings additionalSettings() {
        ...
        if(!openDistroSSLConfig.isSslOnlyMode()){
          ...
          builder.put(NetworkModule.HTTP_TYPE_KEY, "org.opensearch.security.http.OpenDistroSecurityHttpServerTransport");
        }
