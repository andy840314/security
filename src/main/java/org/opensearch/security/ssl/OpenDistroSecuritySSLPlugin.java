...
import org.opensearch.security.ssl.http.netty.OpenDistroSecuritySSLNettyHttpServerTransport;
import org.opensearch.security.ssl.http.netty.ValidatingDispatcher;
import org.opensearch.security.ssl.rest.OpenDistroSecuritySSLInfoAction;
...
import org.opensearch.security.ssl.transport.OpenDistroSecuritySSLTransportInterceptor;
...
//    }
    ...
    public Map<String, Supplier<HttpServerTransport>> getHttpTransports(Settings settings, ThreadPool threadPool, BigArrays bigArrays,
        ...
        if (!client && httpSSLEnabled) {
            ...
            return Collections.singletonMap("org.opensearch.security.ssl.http.netty.OpenDistroSecuritySSLNettyHttpServerTransport", () -> sgsnht);
    ...
    public Settings additionalSettings() {
       ...
       if(!client && httpSSLEnabled) {
           ...
           builder.put(NetworkModule.HTTP_TYPE_KEY, "org.opensearch.security.ssl.http.netty.OpenDistroSecuritySSLNettyHttpServerTransport");
       }
