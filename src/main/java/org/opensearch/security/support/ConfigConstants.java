...
public class ConfigConstants {
    ...
    public static final String SECURITY_AUDIT_LOG_REQUEST_BODY = "plugins.security.audit.log_request_body";
    public static final String SECURITY_AUDIT_RESOLVE_INDICES = "plugins.security.audit.resolve_indices";
    public static final String SECURITY_AUDIT_ENABLE_REST = "plugins.security.audit.enable_rest";
    public static final String SECURITY_AUDIT_ENABLE_TRANSPORT = "plugins.security.audit.enable_transport";
    public static final String SECURITY_AUDIT_CONFIG_DISABLED_TRANSPORT_CATEGORIES = "plugins.security.audit.config.disabled_transport_categories";
    public static final String SECURITY_AUDIT_CONFIG_DISABLED_REST_CATEGORIES = "plugins.security.audit.config.disabled_rest_categories";
    ...
    public static final String SECURITY_AUDIT_IGNORE_USERS = "plugins.security.audit.ignore_users";
    public static final String SECURITY_AUDIT_IGNORE_REQUESTS = "plugins.security.audit.ignore_requests";
    public static final String SECURITY_AUDIT_RESOLVE_BULK_REQUESTS = "plugins.security.audit.resolve_bulk_requests";
    ...
    public static final String SECURITY_AUDIT_EXCLUDE_SENSITIVE_HEADERS = "plugins.security.audit.exclude_sensitive_headers";
    ...
    public static final String SECURITY_COMPLIANCE_HISTORY_WRITE_METADATA_ONLY = "plugins.security.compliance.history.write.metadata_only";
    public static final String SECURITY_COMPLIANCE_HISTORY_READ_METADATA_ONLY = "plugins.security.compliance.history.read.metadata_only";
    public static final String SECURITY_COMPLIANCE_HISTORY_READ_WATCHED_FIELDS = "plugins.security.compliance.history.read.watched_fields";
    public static final String SECURITY_COMPLIANCE_HISTORY_WRITE_WATCHED_INDICES = "plugins.security.compliance.history.write.watched_indices";
    public static final String SECURITY_COMPLIANCE_HISTORY_WRITE_LOG_DIFFS = "plugins.security.compliance.history.write.log_diffs";
    public static final String SECURITY_COMPLIANCE_HISTORY_READ_IGNORE_USERS = "plugins.security.compliance.history.read.ignore_users";
    public static final String SECURITY_COMPLIANCE_HISTORY_WRITE_IGNORE_USERS = "plugins.security.compliance.history.write.ignore_users";
    public static final String SECURITY_COMPLIANCE_HISTORY_EXTERNAL_CONFIG_ENABLED  = "plugins.security.compliance.history.external_config_enabled";
    ...
    public static final String SECURITY_COMPLIANCE_HISTORY_INTERNAL_CONFIG_ENABLED  = "plugins.security.compliance.history.internal_config_enabled";
